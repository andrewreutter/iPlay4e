...
<xsl:include href="/TIME_TOKEN/xsl/UIMobile.xsl" />
    ...
    <html>
        <head>
            ...
            <style>
                ...
                {	background-image: url(/TIME_TOKEN/images/d2024px.png); background-repeat: no-repeat; background-position: 97% 8px; 
                }
                .EdgedList ul li.Roller .secondary { margin-right:12%; }

                .EdgedList ul li.withHelp
                {	background-image: url(/TIME_TOKEN/images/question_frame.png); background-repeat: no-repeat; background-position: 96% 12px; 
                }
                ...
                {	background-image: url(/TIME_TOKEN/images/question_frame.png); background-repeat: no-repeat; background-position: 96% 0; 
                }

                .EdgedList ul li.ActiveLI,
                .EdgedList ul li#AddConditionLI
                {	cursor:pointer;
	                background-image: url(/TIME_TOKEN/images/plus_circle.png); background-repeat: no-repeat; background-position: 96% 12px; 
                }
                ...
                {   padding-left:24px;
	                background-image: url(/TIME_TOKEN/images/minus_circle.png); background-repeat: no-repeat; background-position: 0 0; 
                    cursor:pointer;
            ...
            <script type="text/javascript" language="javascript" src="/TIME_TOKEN/js/combo.js" />
            <script type="text/javascript" language="javascript" src="/TIME_TOKEN/js/jPint.js" />
            ...
            <h2>
                <div>
                    <a href="{@enhancementurl}" target="{generate-id(@name)}">
                        <div class="HelpH2Link"><img src="/TIME_TOKEN/images/question_frame.png" /></div>
                        <xsl:value-of select="@name" />
                    </a>
                </div>
            </h2>
...
<xsl:template name="h1">
    ...
    <h1>
        ...
        <div class="TitlePageLinks">
            <a class="Die" href="#{$character/@key}dice"><img src="/TIME_TOKEN/images/d2024px.png" /></a>
            <a class="TitleNav TitleNavBuild Active" href="#{$character/@key}build" style="margin-left:11px;"
             title="Build (level, XP, race, class, paragon path, epic destiny)"><img src="/TIME_TOKEN/images/build.png" /></a>
            <a class="TitleNav TitleNavMain" href="#{$character/@key}main"
             title="Other (feats, skills, abilities, alignment, vision, size, languages, proficiencies)"><img src="/TIME_TOKEN/images/lists.png" /></a>
            <a class="TitleNav TitleNavLoot" href="#{$character/@key}loot"
             title="Loot (money, daily magic item uses, armor, weapons, magic items, equipment)"><img src="/TIME_TOKEN/images/loot.png" /></a>
            <a class="TitleNav TitleNavCombat" href="#{$character/@key}combat"
             title="Combat (initiative, speed, defenses, conditions, HP, surges, rest, immediate actions)"><img src="/TIME_TOKEN/images/combat.png" /></a>
            <a class="TitleNav TitleNavPowers" href="#{$character/@key}powers"
             title="Powers (by action type and usage)"><img src="/TIME_TOKEN/images/powers.png" /></a>
            <xsl:text>&#160;</xsl:text>
        </div>
